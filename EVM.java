...
class VotingMachineGUI extends JFrame {
    ...
    private void createGUI() {
        ...
        JLabel electionCommissionLabel = new JLabel("<html><b>The Election Commission Of Pakistan</b></html>");
    ...
    private class VoteButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (voterIdStr.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please enter Voter ID.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try {
                ...
                if (voterIndex != -1 && !votedStatus[voterIndex]) {
                    ...
                    JOptionPane.showMessageDialog(null, "Invalid Voter ID. Please enter a valid number.", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(null, "This voter has already cast a vote.", "Error", JOptionPane.ERROR_MESSAGE);
                }
    ...
    private class ResultButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (winner != null) {
                result.append("\nWinner: ").append(winner.getName()).append(" (Symbol: ").append(winner.getSymbol()).append(")");
            }

            JTextArea resultTextArea = new JTextArea(result.toString());
            resultTextArea.setFont(new Font("Arial", Font.BOLD, 16));
            resultTextArea.setEditable(false);
            JOptionPane.showMessageDialog(null, new JScrollPane(resultTextArea), "Election Result", JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
